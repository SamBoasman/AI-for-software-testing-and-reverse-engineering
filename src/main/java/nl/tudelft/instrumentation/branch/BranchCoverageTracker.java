...
public class BranchCoverageTracker {
  ...
  private static void writeCoverageToFile() {
    ...
    String outputFile = System.getProperty("coverage.report.path",
        "src/main/resources" + File.separator + "branch-coverage.json");
  ...
  /**
   * This method is always executed when the execution ends to write the coverage results into a
   * json file
   */
  static {
