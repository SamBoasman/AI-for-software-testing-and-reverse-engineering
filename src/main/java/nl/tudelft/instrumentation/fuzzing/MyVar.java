...
/**
 * This class is used to wrap the primitive types and expressions in an object. This way we can keep
 * track of values and operators that were used. It also makes it easier for us to compute the
 * branch distance.
 *
