...
/**
 * This class serves as a wrapper object for each of the java primitive types that are used in the
 * RERS problems. With this class, we can transform and store each variable that is defined in a
 * RERS problem as a Z3 Expression. The Z3 expression can then be used in the construction of a path
