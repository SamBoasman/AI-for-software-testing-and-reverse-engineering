...
class BranchCoverageVisitorTest {
  ...
  public CompilationUnit instrument(String code, String testName) {
    ...
    // instrumentation
    unit.accept(new BranchCoverageVisitor(testName), null);
    return unit;
  }
  ...
  public void testSimpleIf() {
    ...
    CompilationUnit unit = instrument(code, "testSimpleIf");
    System.out.println(unit.toString());

    int count = StringUtils.countMatches(unit.toString(),
        "nl.tudelft.instrumentation.branch.BranchCoverageTracker.updateCoverage");
    assertTrue(unit.toString()
        .contains("nl.tudelft.instrumentation.branch.BranchCoverageTracker.updateCoverage"));
  ...
  public void testSimpleIfElse() {
    ...
    CompilationUnit unit = instrument(code, "testSimpleIfElse");
    System.out.println(unit.toString());
  ...
  public void testBlockIfElse() {
    ...
    CompilationUnit unit = instrument(code, "testBlockIfElse");
    System.out.println(unit.toString());
  ...
  public void testSimpleFor() {
    ...
    CompilationUnit unit = instrument(code, "testSimpleFor");
    System.out.println(unit.toString());
  ...
  public void testNestedFor() {
    ...
    CompilationUnit unit = instrument(code, "testNestedFor");
    System.out.println(unit.toString());
  ...
  public void testSimpleWhile() {
    ...
    CompilationUnit unit = instrument(code, "testSimpleWhile");
    System.out.println(unit.toString());
  ...
  public void testNestedWhile() {
    ...
    CompilationUnit unit = instrument(code, "testNestedWhile");
    System.out.println(unit.toString());
  ...
  public void testSimpleForEach() {
    ...
    CompilationUnit unit = instrument(code, "testSimpleForEach");
    System.out.println(unit.toString());
  ...
  public void testSwitch() {
    ...
    CompilationUnit unit = instrument(code, "testSwitch");
    System.out.println(unit.toString());
  ...
  public void testNestedSwitch() {
    ...
    CompilationUnit unit = instrument(code, "testNestedSwitch");
    System.out.println(unit.toString());
  ...
  public void testLambdaIf() {
    ...
    String code = builder.toString();
    CompilationUnit unit = instrument(code, "testLambdaIf");
    System.out.println(unit.toString());
